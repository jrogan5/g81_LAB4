...
--      6. Map the wrapper_rad4 segments to the on-board segments 
...
entity wrapper_rad4 is
    Port (  input_operand   : in std_logic_vector(7 downto 0);
            clk             : in std_logic;     -- clock: connected to 50 MHz on-board
...
architecture arch of wrapper_rad4 is
    signal in1, in2 : std_logic_vector(7 downto 0); -- internal input signals
    signal mult_out : std_logic_vector(15 downto 0); -- output of Booth's multiplier
    ...
    component Radix4_Booth_Mult is
